...
const ImgSlider = () => {
  return (
    <Swiper
    spaceBetween={50}
    className=' w-[100%]  mt-10 rounded-xl'
  ...
  >
    <SwiperSlide className='rounded-lg   h-[55vh]   '>
      <div className='  rounded-lg flex z-10    shadow-[inset_752px_90px_100px_#292929fc] justify-end'>
      <img className='w-[60%] -z-[1]  rounded-lg' src="https://image.tmdb.org/t/p/original/5iilESGDr44JUO5as6KzejxkvJd.jpg" alt="" />
      </div>
    ...
    </SwiperSlide>      <SwiperSlide className='rounded-lg   h-[55vh]   '>
      <div className='  rounded-lg flex z-10    shadow-[inset_752px_90px_100px_#292929fc] justify-end'>
      <img className='w-[60%] -z-[1]  rounded-lg' src="https://image.tmdb.org/t/p/original/5iilESGDr44JUO5as6KzejxkvJd.jpg" alt="" />
      </div>
