...
import SliderUitil from "./SliderUitil";
...
const Home = (props) => {
  ...
  // const [popularmovieIds, setPopularmovieIds] = useState([]);
  // const [populartvIds, setPopulartvIds] = useState([]);
    ...
    const fetchDataForAllEndpoints = async () => {
      ...
      await Promise.all([
        ...
        fetchData(
          ...
          // fetchIdsForMediaType(data, setTopRatedmovieIds);
        }),  
        fetchData(
          "https://api.themoviedb.org/3/trending/all/day?api_key=c5ad2827c51f36bcbad41dc821d6d7c1",
          setTopDay,
        ...
        fetchData(
          "https://api.themoviedb.org/3/movie/popular?language=en-US&page=1&api_key=c5ad2827c51f36bcbad41dc821d6d7c1",
          setPopular,
          "popular"
        ).then((data) => {
          // fetchIdsForMediaType(data, setPopularmovieIds, setPopulartvIds);
          // console.log(data);
        }),
        fetchData(
          "https://api.themoviedb.org/3/movie/upcoming?language=en-US&page=1&api_key=c5ad2827c51f36bcbad41dc821d6d7c1",
          setUpcoming,
          "upcoming"
        ).then((data) => {
          // fetchIdsForMediaType(data, setPopularmovieIds, setPopulartvIds);
  ...
  return (
    <Container className=" relative   top-[72px]  bg-[#141414]  overflow-x-hidden  ">
      <ImgSlider />
      <Viewers />
      <NewTrending
        topDay={topDay}
      ...
      <SliderUitil
        ...
        // topRatedImagesMovie={topRatedImagesMovie}
      />
      <SliderUitil
        data={popular}
